...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #right img { width: 550px; }
        #left img { width: 140px; height: 70px; }
        .tagline { 
            background: #fff6e6; 
            color: #6c5ce7; 
            padding: 10px 20px; 
        ...
        @media (max-width: 768px) {
            ...
            /* Specific adjustments for the right card container */
...
<body>
    ...
    <div id="main_content">
            ...
            <div class="card-container">
                <a href="live.php">
                    <div class="card">
                        <div class="card-icon-container">
                            <img src="image/live.png" alt="Live" style="width: 140px; height: 70px;">
                        </div>
                ...
                <a href="recap.php">
                    <div class="card" style="background-color: #7c44f5; color: white;">
                        <div class="card-icon-container">
                            <img src="image/recap.png" alt="Rekap" style="width: 140px; height: 70px;">
                        </div>
        ...
        <div id="right">
            <img src="image/cartoon2.png" alt="Ilustrasi" style="padding: 10px; margin-bottom: 20px;">
            <div class="card-container" style="justify-content: center; align-items: center; margin-bottom: 60px;">
                <a href="listG.php">
                    <div class="card">
                        <div class="card-icon-container">
                            <img src="image/listG.png" alt="Daftar Guru" style="width: 140px; height: 70px;">
                        </div>
                        <div style="margin-top: 5px; font-size: 15px; font-weight: bold;">Daftar</div>
                        <div style="font-size: 15px; font-weight: bold;">Guru</div>
                    </div>
                </a>
                ...
                <a href="listS.php">
                    <div class="card" style="background-color: #7c44f5; color: white;">
                        <div class="card-icon-container">
                            <img src="image/listS.png" alt="Daftar Siswa" style="width: 140px; height: 70px;">
                        </div>
                        <div style="margin-top: 5px; font-size: 15px; font-weight: bold;">Daftar</div>
                        <div style="font-size: 15px; font-weight: bold;">Siswa</div>
                    </div>
                </a>
            </div>
        </div>
