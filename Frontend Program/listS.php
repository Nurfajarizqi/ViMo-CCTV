...
<body>
    ...
    <div id="main_content">
        <div id="left">
            <?php for ($i = 1; $i <= 6; $i++): ?>
                <a href="listS.php?kelas=<?= $i ?>" class="kelas-btn <?= $kelas == $i ? 'active' : '' ?>">
                    Kelas <?= $i ?>
                </a>
            <?php endfor; ?>
        </div>
        ...
        <div id="right">
            ...
            <table>
                ...
                <?php
                    $no = 1;
                    $result = $conn->query("
                        SELECT s.nama_lengkap, s.nisn, s.tanggal_lahir, k.nama_kelas 
                        FROM siswa s
                ...
                <tr>
                    <td><?= $no++ ?></td>
                    <td><input type="text" value="<?= htmlspecialchars($row['nama_lengkap']) ?>" readonly></td>
                    <td><input type="text" value="<?= htmlspecialchars($row['nisn']) ?>" readonly></td>
                    <td><input type="text" value="<?= htmlspecialchars($row['tanggal_lahir']) ?>" readonly></td>
                    <!-- <td><input type="text" value="<?= htmlspecialchars($row['nama_kelas']) ?>" readonly></td> -->
                </tr>
                <?php endwhile; ?>
