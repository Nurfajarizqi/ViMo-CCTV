...
$id_mata_pelajaran = 3; // ID for ipa
...
<body>
    ...
    <div id="main_content">
        <div id="left">
            <?php for ($i = 1; $i <= 6; $i++): ?>
                <a href="ipa.php?kelas=<?= $i ?>" class="kelas-btn <?= ($kelas_id == $i) ? 'active' : '' ?>" data-kelas="<?= $i ?>">
                    Kelas <?= $i ?>
                </a>
            <?php endfor; ?>
        </div>
        ...
        <div id="right">
            <div class="judul-wrapper">
                <div id="judul_kelas">Tampilan Emosi Siswa di <?= $kelas_nama ?> (IPA)</div>
    ...
    <script>
        ...
        const idMataPelajaran = 3; // ID untuk ipa
