...
$id_mata_pelajaran = 2; // ID for bahasa
...
<body>
    ...
    <div id="main_content">
        <div id="left">
            <?php for ($i = 1; $i <= 6; $i++): ?>
                <a href="bahasa.php?kelas=<?= $i ?>" class="kelas-btn <?= ($kelas_id == $i) ? 'active' : '' ?>" data-kelas="<?= $i ?>">
                    Kelas <?= $i ?>
                </a>
            <?php endfor; ?>
        </div>
        ...
        <div id="right">
            <div class="judul-wrapper">
                <div id="judul_kelas">Tampilan Emosi Siswa di <?= $kelas_nama ?> (BAHASA)</div>
    ...
    <script>
        ...
        const idMataPelajaran = 2; // ID untuk bahasa
