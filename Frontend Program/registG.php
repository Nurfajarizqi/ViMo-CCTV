...
include 'db.php';
$pelajaran = [];
$mp_query = "SELECT id, nama_mata_pelajaran FROM mata_pelajaran";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO guru (nama_lengkap, nuptk, tanggal_lahir, id_mata_pelajaran) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $nama_lengkap, $nuptk, $tanggal_lahir, $id_mata_pelajaran);
    $stmt->execute();
    
    // Redirect to prevent form resubmission
    header("Location: registG.php?success=1");
    exit();
}
?>
...
<head>
  ...
  <title>Registrasi Guru - SD Negeri X</title>
  <style>
...
<body>
  ...
  <div id="main_content">
    <div id="left">
      <a class="menu-btn active" href="registG.php">Registrasi Guru</a>
      <a class="menu-btn" href="registS.php">Registrasi Siswa</a>
    </div>

    <div id="right">
      <div class="form-wrapper">
        <?php if (isset($_GET['success'])): ?>
          <div class="success-message">Guru berhasil Didaftarkan!</div>
        <?php endif; ?>
          <form method="post">
